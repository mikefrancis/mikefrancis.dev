        ...
        <article className="max-w-3xl mx-auto space-y-10">
          ...
          <div className="wysiwyg">
            ...
            <p>
              ...
              (13-inch, 2018). I&apos;m not a fan of wider laptops as I like to
              be able to stash my laptop into my bag for a long train journey or
            ...
            <p>
              ...
              . I mainly use the keyboard as it&apos;s the same size and layout
              as my laptop keyboard. I switched from a mouse to a trackpad for
              the same reason and found using a trackpad a bit less movement for
              my wrist on a long day.
            </p>
            <p>
            ...
            <p>
              ...
              minimal and unstructured, so up until recently post-it notes have
              sufficed.
            </p>
            <p>
              However I don&apos;t always have them to hand and it&apos;s not a
              sustainable way to keep track of tasks so I&apos;ve ditched that
              idea in favour of the following.
            </p>
            <p>
              I&apos;m an <a href="https://www.alfredapp.com">Alfred</a> user,
              and have purchased the powerpack, so I use a workflow to post the
              following format:
            </p>
            <pre>
            ...
            <p>
              ...
              &quot; way of creating tasks very non-intrusive and I can access
              this backlog from anywhere.
            </p>
          </div>
        </article>
      </Layout>
