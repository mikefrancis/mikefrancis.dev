...
const Footer = ({ siteTitle}) => (
    <footer
        className="md:fixed md:pin-b z-0 w-full bg-grey-lighter pt-16 md:pt-32 pb-8 text-grey-darker"
    >
                ...
                <ul className="justify-center list-reset pb-8 flex">
                    <li className="mx-3">
                        <a className="block" href="https://github.com/mikefrancis" title="GitHub">
                            <svg className="text-grey hover:text-grey-dark" width="24" height="24" viewBox="0 0 1792 1792" xmlns="https://www.w3.org/2000/svg">
