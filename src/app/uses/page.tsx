  ...
  return (
    <article className="max-w-3xl mx-auto space-y-10">
      ...
      <div className="wysiwyg">
        ...
        <ul>
          <li>
            <a href="https://nextjs.org">Next.js</a> as a Static-Site Generator.
            Pages are built using React written in TypeScript.
          </li>
          <li>
            <a href="https://tailwindcss.com">TailwindCSS</a> for styling.
          </li>
          <li>
            <a href="https://fonts.google.com/specimen/Work+Sans">Work Sans</a>{' '}
          ...
          <li>
            <a href="https://www.netlify.com">Netlify</a> for deployment and
            hosting.
          </li>
        </ul>
        ...
        <p>
          ...
          <a href="https://twitter.com/jeffrey_way">Jeffrey Way</a> - I found I
          wasn&apos;t using that key for anything so it made sense to map it to
        ...
        <p>
          ...
          it&apos;s use of glyphs as visual indicators really useful. Also I use{' '}
          <a href="https://gist.github.com/stidges/352d18a724258e93f13bc48d4168d16b">
            tailwind
          </a>{' '}
          as the colour scheme and{' '}
          <a href="https://www.jetbrains.com/lp/mono">JetBrains Mono</a> as the
          font.
        </p>
        <p>
        ...
        <p>
          I try to install all of these using Homebrew, and as such they should
          all listed in my{' '}
        ...
        <p>
          ...
          able to stash my laptop into my bag for a long train journey or trip
          to a coffee shop.
        </p>
        <p>
          ...
          my laptop keyboard. I switched from a mouse to a trackpad for the same
          reason and found using a trackpad a bit less movement for my wrist on
          a long day.
        </p>
        <p>
          I use an <a href="https://www.apple.com/iphone">iPhone X</a> for
          communication and taking pictures, and listen to music, podcasts and
          audio books using a pair of{' '}
        ...
        <p>
          ...
          involve me learning a new piece of software. I&apos;d like to think my
        ...
        <p>
          To a personal kanban <a href="https://trello.com">Trello</a> board. I
          only view the Trello board when I need to, or at the start/end of each
          day, and it has a butler set up which archives anything in
          &quot;Done&quot; each week.
        </p>
        <p>
          It&apos;s not perfect but I find this &quot;fire <s>and forget</s>
          &quot; way of creating tasks very non-intrusive and I can access this
          backlog from anywhere.
        </p>
      </div>
    </article>
  );
